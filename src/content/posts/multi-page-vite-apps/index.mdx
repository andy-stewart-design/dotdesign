...
date: '2022-12-14'
summary: Because I cannot be bothered to use Webpack
...
If you would prefer to skip my explication and parse the code yourself, you can find it on Github here.
...
<Callout>
	By default, Vite only serves `index.html` files. So, for example, it will recognize
	`about/index.html` as a page, but not `about.html`.
</Callout>
