	...
	<div class="flex flex-col sm:flex-row gap-2">
		<div class="relative grow border border-gray-100/10 rounded-lg">
			...
			<svg viewBox="0 0 20 20">
				...
				<line {x1} {y1} {x2} {y2} stroke="blue" class="stroke-blue-600 stroke-[0.2]" />
				<circle cx={x1} cy={y1} r="0.3" class="fill-blue-600 stroke-[0.05] stroke-blue-500" />
				<circle cx={x2} cy={y2} r="0.3" class="fill-blue-600 stroke-[0.05] stroke-blue-500" />
			</svg>
		</div>
		<div
